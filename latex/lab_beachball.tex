...
\item Convince yourself that if the reorientation is a rotation of \dg{90} about \pvec, then $\omega$ is small to moderate.

\item CHALLENGE: Derive $\omega=\pi/3$ for a rotation of \dg{90} about \pvec.

\item CHALLENGE: Derive $\omega=\pi/3$ for a rotation of \dg{90} about \tvec.
