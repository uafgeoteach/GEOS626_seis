...
\newcommand{\fvecp}{\textcolor{yellow}{\mbP}}
\newcommand{\fvecn}{\mbN}
\newcommand{\fvecs}{\mbS}
...
\item Derive $\omega=\pi/3$ for a rotation of \dg{90} about \fvecp.

\item Derive $\omega=\pi/3$ for a rotation of \dg{90} about \fvect.
