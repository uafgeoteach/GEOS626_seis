% dvips -t letter labsol_beachball.dvi -o labsol_beachball.ps ; ps2pdf labsol_beachball.ps
...
\item Rotate the ball \dg{180} about any one of \mbT, \mbB, or \mbP.
%
\begin{enumerate}
...
\item Convince yourself that if the reorientation is a rotation of \dg{90} about \mbT, then the angle $\omega$ is small to moderate. (Calculation gives $\omega=\pi/3$.)

\end{enumerate}

%---------------------------

%\item Rotate the ball \dg{90} about \mbB. Find $\omega$.

%---------------------------

%\item Rotate the ball \dg{180} about \mbN\ or \mbS. Find $\omega$.
