...
\cltag\ \\
Assigned: January 22, \cyear\ --- Due: January 29, \cyear\ \\
Last compiled: \today \\
\end{spacing}
...
{\bf Except for Problem 1}, you are welcome to use a computer to support your answers. If you find yourself doing horrendous algebra, then probably you have made a prior mistake. Please try out \verb+notes_math.ipynb+ for tips on doing linear algebra in Python.
