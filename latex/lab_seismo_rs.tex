...
\item the widest period range over which the signal is clearly visible. This can be achieved by varying \verb+T1+ and \verb+T2+ provided as an input for plotting the record sections. You do not need to re-extract the waveforms.
\end{itemize}
%
\begin{table}[h]
\centering
