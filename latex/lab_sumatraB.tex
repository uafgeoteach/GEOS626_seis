...
Your seismograms will be saved in the folder \verb+datawf+ in the subfolder \verb+sumatra_LHZ_raw/SAC/+.
...
\item These will have the response removed to acceleration. Your seismograms will be saved locally in the subfolder \verb+sumatra_LHZ_acc/SAC+. Acceleration spectra are preferred output for analyzing normal modes.

\item The next set of data will have the response removed to displacement. Your seismograms will be saved locally in the subfolder \verb+sumatra_BHZ_disp/SAC+.
