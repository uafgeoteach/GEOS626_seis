...
\item Aside: the \textbf{Global Seismographic Network (GSN)}. The GSN is composed of four seismic networks (see details at \url{https://www.fdsn.org/networks/}):
%
\begin{enumerate}
\item \textbf{IU}. GSN--USGS. Publications: \citet{OliverMurphy1971,Ringler2020gsn,Wilson2024}.

\item \textbf{II}. GSN--EarthScope. Publications: \citet{Agnew1986,Davis2024}. Prior to September 2024, the II network was run by Project IDA at the UCSD Scripps Institute of Oceanography.

\item \textbf{IC}. New China Digital Seismograph Network - USGS. Publications: \citet{Anderson2015}.

\item \textbf{CU}. Caribbean Network - USGS.  Publications: \citet{Ringler2020gsn,Wilson2024,Wilgus2024}.
\end{enumerate}

\item We select stations from three seismic networks, two of which are part of the GSN: \\

\begin{tabular}{cll}
\hline
G   & Geoscope        & Institut de Physique du Globe de Paris \\
II  & GSN-EarthScope  & EarthScope Consortium \\
IU  & GSN-USGS        & USGS Albuquerque Seismological Laboratory \\
\hline
\end{tabular} \\

\noindent
The Geoscope network is managed by France and has been running high-quality stations since 1982 \citep{Leroy2024}.
II and IU are part of the GSN \citep{Davis2024,Wilson2024}.
...
\begin{enumerate}
\item Examine \tfile. List the parameters specified in the data download request:
...
\item In the relevant code cell, set the flag \verb+plot_seismogram+ to \verb+True+ and examine the seismograms. Describe three ``errors'' in the seismograms that should probably be rejected\footnote{This rejection will depend on what the specific science questions are. Potentially a seismogram with poor quality at the lowest frequencies could still be useful for analyses based on high frequencies.} from the analysis.
