...
\begin{enumerate}
\item Examine \tfile. There are two sets of waveforms that are requested; each set is associated with a different time interval and sample rate. List the specified parameters for each set below. {\bf If there are more than three posssibilities, only list three.}
