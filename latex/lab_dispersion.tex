...
\item Measure the phase between PAS and NEE for the 20~s harmonic; use the function \verb+markt+ defined for you (note \footnote{See lab_fft.ipynb or hw_inv.ipynb to see how to interact with figures}) to click points on your plots. 
%
\begin{eqnarray*}
t_1 &=& 
\\
