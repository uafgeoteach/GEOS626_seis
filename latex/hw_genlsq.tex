...
\item (0.5) List each matrix in \refEqab{mpost1}{cpost2} that must be inverted. Also list the dimensions of each matrix, assuming that there are $M$ model parameters and $N$ observations.
\end{enumerate}
