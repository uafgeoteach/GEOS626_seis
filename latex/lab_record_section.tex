...
\item The two main procedures are executed using the software package PySep (\url{https://pysep.readthedocs.io/en/devel/index.html}), which uses ObsPy \citep{obspy2010,obspy2011,obspy2015}.
...
\scriptsize
\url{https://pysep.readthedocs.io/en/devel/autoapi/pysep/recsec/index.html#pysep.recsec.RecordSection}
\normalsize
