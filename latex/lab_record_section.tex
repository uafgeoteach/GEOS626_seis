...
\item Example 6.1, 6.2 and 6.3: other earthquakes during the Sumatra \magw{8.6} earthquake in Alaska.
...
\caption[]
{{
Possibly triggered earthquakes during the 2012 Sumatra \magw{8.6} earthquake in Alaska. List the bandpass range that you used to make your assessments.
\label{tab:triggered}
}}
\begin{spacing}{1.5}
