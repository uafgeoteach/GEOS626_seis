...
\item 9.1 is the official listing from USGS. This is rounded from 9.15 from \citet{Duputel2012}, which is based on the W phase.

\item 9.14 is via $M_0 = 6.5 \times 10^{22}$~N-m of the finite source model by Chen Ji (Model III) from \citet{Ammon2005}.
