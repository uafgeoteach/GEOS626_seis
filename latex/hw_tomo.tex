...
\item In order to do the inverse problem, you will need the data vector of traveltime measurements (\refeq{d}). Load the column vector \verb+measure_vec.dat+, and check that it has dimension $3300 \times 1$.
